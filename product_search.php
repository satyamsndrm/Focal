...
$src=(isset($_GET['src']))?mysqli_real_escape_string($db,trim($_GET['src'])):"";
$price='';
?>
						...
						<div class="page-selector">
							...
							<div class="shop-grid-controls">
								<div class="entry">
									...
									<div class="sort-button" id="dec" search="<?php echo $src; ?>"></div>
								</div>
								<div class="entry">
									<div class="view-button active grid hidden-xs"><i class="fa fa-th"></i></div>
								</div>
...
<?php
$href="product_search.php?src=$src&page=";
$sql="SELECT SQL_CALC_FOUND_ROWS
	...
	WHERE
	p.p_name LIKE '%$src%' OR c.cat_keywords LIKE '%$src%'
